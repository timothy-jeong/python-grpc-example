...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in member_service_pb2_grpc.py depends on'
...
class MemberService(object):
    ...
    def GetMember(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/member.MemberService/GetMember',
            message_dot_member__request__pb2.MemberRequest.SerializeToString,
            message_dot_member__response__pb2.MemberResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
